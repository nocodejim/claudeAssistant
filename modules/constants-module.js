...
const prompts = {
  ...
  REQUIREMENT_GENERATE_SCENARIOS: "Write the BDD scenarios for the following software requirement. For each scenario use the following format { \\\"Scenarios\\\": [{ \\\"Name\\\": [The name of the scenario], \\\"Given\\\": [single setup in plain text], \\\"When\\\": [single action in plain text], \\\"Then\\\": [single assertion in plain text] }] }",
